...
#endif
		} else if (grabberType == INPUT_OFXCLEYE) {
#ifdef TARGET_WIN32
            vidGrabber = new clVideoGrabber;
            clVideoGrabber& cam = *((clVideoGrabber*) vidGrabber);
            cam.setup(width, height, false);
            //cam.vidGrabber.listDevices();
            width = cam.width;
            height = cam.height;
#endif
		}
