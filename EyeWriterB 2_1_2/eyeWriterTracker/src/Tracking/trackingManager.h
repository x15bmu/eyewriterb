...
public:
	...
	/** Check if the even frame holds a bright eye (true) or a dark eye (false). */
	bool evenBright();
	/** Returns an IplImage with the bright and dark eyes stiched together into one image */
	IplImage* getOverlayImage();
	...
	int clLastGain, clLastExposure;
	bool clLastAutoExposure, clLastAutoGain;
